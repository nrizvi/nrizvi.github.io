...
<div class="row">
<div class="col col-md-6 col-sm-12 col-xs-12 text-left"><p>Autism is multi-dimensional and can be understood in a variety of ways.
...
<div class="col text-center"><br>
   <h3><a href="https://dl.acm.org/doi/10.1145/3613904.3642798">Read</a> our full paper and
        ...
        <!-- Clickable text to trigger modal -->
<a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">click here to cite it!</a></h3><br><br>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Copy Citation</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <textarea id="citationText" class="form-control" rows="10">
    ...
    series = {CHI '24}
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="copyText()">Copy to Clipboard</button>
              </div>
            </div>
          </div>
        </div>
...
<div class="row align-items-center">
 <div class="col-md-6 col-sm-12 col-xs-12 chart-container">
    ...
    This graph is interactive: you can hide any category by clicking on its corresponding label.
    </p>
</div>

<div class="col-md-6 col-sm-12 col-xs-12 chart-container">
        <div id="pictogram"></div>
        <p class="chartCaption">Figure 2. Less than 10% of HRI papers (shown in pink) included a representative sample of women and girls with autism in their studies. The majority (in yellow) did not report the participants' gender demographics.</p>
    </div>
</div>
<div class="row">
<div class="col text-center">
